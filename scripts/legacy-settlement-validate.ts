/**
 * Optional read-only diagnostic for the retired atomic settlement protocol.
 * This is not the standard x402 client path. Use npm run validate:mainnet
 * for current operator readiness; this legacy transaction may require its
 * own lookup table even when current two-step x402 transactions fit.
 *
 ...
 *
 * Usage:
 *   SOLANA_RPC_URL=... npx tsx scripts/legacy-settlement-validate.ts
 * Optional:
